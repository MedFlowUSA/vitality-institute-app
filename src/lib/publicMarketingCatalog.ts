...
export const PUBLIC_OFFERINGS: PublicOffering[] = [
  {
    ...
    serviceDetails: "The $149 consultation covers provider review of goals, health history, and treatment fit. Labs may be reviewed or ordered when clinically appropriate.",
  ...
  },
  {
    ...
    summary: "Base in-clinic IV drips start at $199, with optional NAD+ 1000 and B12 add-ons.",
    price: "$199 base",
    overview: "A flexible in-clinic IV drip visit built around a base drip with optional add-ons depending on treatment goals and provider guidance.",
    idealFor: "Patients seeking hydration, recovery, energy, or higher-touch infusion support in clinic.",
    serviceDetails: "Base IV drip pricing starts at $199. NAD+ 1000 is an additional $199. B12 add-on pricing starts at $49.",
    whatToExpect: "Expect in-clinic timing and add-on selection to be reviewed before scheduling is finalized. NAD+ visits require a minimum 2-hour session.",
    faqNotes: [
      "NAD+ 1000 requires a minimum 2-hour visit.",
      "Final timing and add-ons are confirmed with the clinic.",
    ],
  },
  {
