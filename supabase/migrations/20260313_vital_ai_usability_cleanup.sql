  ...
  $${
    ...
    "steps": [
      ...
      },
      {
        ...
        "questions": [
          { "key": "labs_available", "label": "Do you have recent labs available?", "type": "boolean", "required": false },
          {
            "key": "recent_labs",
    ...
    "steps": [
      ...
      },
      {
        ...
        "questions": [
          ...
          { "key": "prior_peptide_use", "label": "Have you used peptides before?", "type": "boolean", "required": false },
          {
    ...
    "steps": [
      {
        ...
        "questions": [
          ...
          { "key": "phone", "label": "Phone number", "type": "text", "required": true },
          { "key": "email", "label": "Email", "type": "text", "required": false },
          { "key": "preferred_contact", "label": "Preferred contact method", "type": "select", "required": false, "options": ["phone", "text", "email"] }
        ]
      },
      {
        "key": "visit_reason",
      ...
      },
      {
        ...
        "questions": [
          ...
          { "key": "current_medications", "label": "Current medications", "type": "textarea", "required": false },
          { "key": "prior_records_available", "label": "Do you want to upload prior records?", "type": "boolean", "required": false }
        ]
      },
      {
        "key": "uploads",
